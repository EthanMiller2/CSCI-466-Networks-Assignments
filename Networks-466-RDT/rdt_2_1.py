        ...
        while sending:
            ...
            if not Packet.corrupt(response[:length]):
                ...
                if responsePacket.seq_num < self.seq_num:
                    print('rdt_2_1_send: resending data')
                    ...
                    print('rdt_2_1_send: positive acknowledgementPacket received')
                    sending = False
                    self.seq_num += 1
                elif responsePacket.msg_S is "0":
                    print('rdt_2_1_send: negative acknowledgementPacket received')
                    self.byte_buffer = ''
            else:
                print('rdt_2_1_send: corrupted acknowledgementPacket received')
                self.byte_buffer = ''
    ...
    def rdt_2_1_receive(self):
        ...
        while True:
            ...
            if Packet.corrupt(self.byte_buffer):
                print('rdt_2_1_receive: packet is corrupt')
                ...
                if p.seq_num < self.seq_num:
                    print('rdt_2_1_receive: resending acknowledgementPacket')
                    answerAcknowledgementPacket = Packet(p.seq_num, "1")
                    self.network.udt_send(answerAcknowledgementPacket.get_byte_S())
                elif p.seq_num == self.seq_num:
                    print('rdt_2_1_receive: new acknowledgementPacket sent')
